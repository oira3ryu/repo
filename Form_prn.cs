                ...
                case 1: // 納額通知書
                    {
                        ...
                        + ", i.g_name"
                        + ", i.gengou"
                        + " from h, t_gengou i where start_date <= to_date((to_number(c4_y,'999')+1988 || '/' || to_number(c4_m,'999')+3 || '/' || 1), 'yyyy/mm/dd') - 1"
                        + " and s_id::Integer = " + Cmb_s_id_int
                        + " and o_id::Integer = " + Cmb_o_id_int
                ...
                case 5: // 引落請求書
                    {
                        ...
                        + ", i.g_name"
                        + ", i.gengou"
                        + " from r, t_gengou i where start_date <= to_date((to_number(c4_y, '999') + 1988 || '/' || to_number(c4_m, '999') + 3 || '/' || 1), 'yyyy/mm/dd') - 1;"
                        //"select"
                        //+ " a.r_id"
                        //+ ", a.c1"
                        //+ ", c.c5"
