    ...
    public partial class Form_prn : Form
    {
        ...
        private void WithdrawalRowUpdated(Object sender, NpgsqlRowUpdatedEventArgs e)
        {
            if (e.Status == UpdateStatus.Continue)
            {
                if (e.StatementType == System.Data.StatementType.Insert)
                {
                    ...
                    (
                        ...
                        //+ ", a.w_flg"
                        //+ " from t_seikyu a"
                        //+ "left join t_seikyu b"
                        //+ " on ("
                        //+ " a.c1 = b.c1"
                        //+ " and a.c3 = b.c3"
                        //+ " and a.c4 = b.c4"
                        //+ " and a.time_stamp > b.time_stamp"
                        //+ " ) left join t_shiharai_houhou c" 
                        //+ " on ("
                        //+ " a.c1 = c.c5"
                        //+ " and a.c3 = c.c6"
                        //+ " and a.s_id = c.s_id"
                        //+ " and a.c4 = case when length(c.c4_array[2])=1 then"
                        //+ " (c.c4_array[1] || '/ ' || c.c4_array[2])"
                        //+ "   when length(c.c4_array[2])=2 then"
                        //+ " (c.c4_array[1] || '/' || c.c4_array[2])"
                        //+ " end)"
                        //+ " left join t_shiharai_houhou d"
                        //+ " on ("
                        //+ " c.c5 = d.c5"
                        //+ " and c.c6 = d.c6"
                        ...
                        //+ " and c.time_stamp > d.time_stamp"
                        //+ " )"
                        //+ " where b.c1 is null and a.w_flg = '1' and c.c9 = '" + cmb_b_code_str + "'"
                        //+ " and a.r_id = currval('t_seikyu_r_id_seq')"
                        //+ " order by a.r_id;"
                    "with recursive r as ("
                    + "select"
                    + " a.r_id"
            ...
            else if (e.StatementType == System.Data.StatementType.Update)
            {
                ...
                (
                    ...
                    //+ " and c.c6 = d.c6"
                    //+ " and c.c4_array = d.c4_array"
                    //+ " and d.time_stamp > c.time_stamp"
                    //+ " )"
                    //+ " where b.c1 is null and a.w_flg = '1' and c.c9 = '" + cmb_b_code_str + "'"
                    //+ " and a.r_id = " + e.Row["r_id"].ToString()
                    //+ " order by a.r_id;"
        ...
        private void cmd_Ins_Click(object sender, EventArgs e)
        {
            ...
            (
                ...
                + " on a.c1=b.c5 and rtrim(replace(a.c3,substr(a.c3,strpos(a.c3, '('), strpos(a.c3, ')')),'')) = rtrim(replace(b.c6,substr(b.c6,strpos(b.c6, '('), strpos(b.c6, ')')),'')) and a.s_id=case substr(b.c4,strpos(b.c4, '[')+1, strpos(b.c4, ']')-strpos(b.c4, '[')-1)"
                    + " when '入所' then '1'"
                    + " when '介護通所' then '2'"
                    + " when '介護短期' then '3'"
                    + " when '予防通所' then '4'"
