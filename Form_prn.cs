                                ...
                                + " ("
                                    + "("
                                        + "("
                                            ...
                                            + " ON a.s_id::Integer = b.s_id AND a.o_id = b.o_id)"
                                                            ...
                                                            + "("
                                                                ...
                                                                + ") a LEFT JOIN (SELECT c4, c5, c6, c7, c11, c14, c15, c16, c19, s_id, o_id,"
                                                                    ...
                                                                    + " WHERE time_stamp = "
                                                                        ...
                                                                        + " LEFT JOIN (SELECT s_id, o_id, syubetsu FROM t_syubetsu) c ON a.s_id::Integer = c.s_id AND a.o_id = c.o_id)"
                ...
                case '1': // 
                    {
                        ...
                        + "WITH RECURSIVE r AS ("
                                ...
                                + ")"
                                + " SELECT"
                                + " distinct array_to_string(ARRAY(select distinct ON (to_number(concat(to_number(ltrim(left(r.c4,3)),'999')+h.diff ,lpad(trim(right(r.c4,2)),2,'0')),'999999')) ltrim(right(r.c4,2)) FROM t_seikyu"
