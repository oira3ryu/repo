                ...
                case 1: // 納額通知書
                    {
                        ...
                        + ", r.c3_mod"
                        + ", r.c4"
                        + ", to_date((to_number(r.c4_y,'999')-12+2000 || '/' || r.c4_m || '/' || 1),'yyyy/mm/dd') first_date"
                        + ", case when left(r.c4_y,1) = 'H' then '平成' end as gengou"
                        + ", cast(case when date_part('month', to_date((to_number(r.c4_y,'999')-12+2000 || '/' || r.c4_m || '/' || 1),'yyyy/mm/dd')::timestamp) < 4 then"
                ...
                case 3: // 収入内訳
                    {
                        ...
                        + ", sum(cast(c7 as integer)) as g_c7"
                        + ", case when left(c4_y,1) = 'H' then '平成' end as gengou"
                        + ", cast(case when date_part('month', to_date((to_number(c4_y,'999')-12+2000 || '/' || c4_m || '/' || 1),'yyyy/mm/dd')::timestamp) < 4 then"
                        + " to_number(c4_y,'999')-1 else to_number(c4_y,'999') end as text) as nendo"
                        + ", to_number(c4_y,'999')::text as nen"
                        + ", to_number(c4_m,'99')::text as tsuki"
                        + " from r"
                        + " group by c4, s_id, o_id, c4_y, c4_m, req_id, syubetsu, tsuki, time_stamp"
                        + " having c4_y ='" + Cmb_nen_str + "'"
                        + " and c4_m::Text = case when length('" + Cmb_tsuki_str + "')=1 then"
                                        + " ' ' || '" + Cmb_tsuki_str + "'"
                                        + "       when length('" + Cmb_tsuki_str + "')=2 then"
                                        + " '' || '" + Cmb_tsuki_str + "'"
                ...
                case 4: // 納入案内
                    {
                        ...
                        + ", t4.col3"
                        + ", t4.col4"
                        + ", case when left(t1.c4_y,1) = 'H' then '平成' end as gengou"
                        + ", t4.col5"
                        + ", t4.ac0"
                        + ", t4.ac1"
                        + ", t4.ac2"
                            ...
                            + " case when t5.b_id = '0' then null"
                                + " when t5.b_id = '1' then" /* 稚内信金の場合の処理*/
                                    + " case when t5.sd = '99' then" /* 翌月末引落の場合の処理 */
                                            + " target_date(to_date((to_number(c4_y,'999')-12+2000 || '/' || to_number(c4_m,'99')+2 || '/' || to_number('01','99')),'yyyy/mm/dd')-1)"
                                    + " else" /* 翌月末引落以外の場合の処理 */
                                            + " target_date(to_date((to_number(c4_y,'999')-12+2000 || '/' || to_number(c4_m,'99')+1 || '/' || to_number(t5.sd,'99')),'yyyy/mm/dd'))"
                                    + " end"
                        ...
                        //+ ", t5,sy"
                        + ", t9.c25 shiharaisya"
                        + " from ((((((((select id, c1, c3, c4, c4_y, c4_m, c4_array, c22, s_id, o_id, req_id"
                ...
                case 5: // 引落請求書
                    {
                        ...
                        (
                            ...
                            + " where"
                            //+ " c4_y::text || '/' || c4_m::Text = case when length('" + Cmb_tsuki_str + "')=1 then"
                            //                                        + " ('" + Cmb_nen_str + "' || '/ ' || '" + Cmb_tsuki_str + "')"
                            //                                        + "       when length('" + Cmb_tsuki_str + "')=2 then"
                            //                                        + " ('" + Cmb_nen_str + "' || '/' || '" + Cmb_tsuki_str + "')"
                            //                                        + " end"
                            ...
                            + ")"
                            //+ " and a.c4_y::text || '/' || a.c4_m::Text = case when length('" + Cmb_tsuki_str + "')=1 then"
                            //                                        + " ('" + Cmb_nen_str + "' || '/ ' || '" + Cmb_tsuki_str + "')"
                            //                                        + "       when length('" + Cmb_tsuki_str + "')=2 then"
                            //                                        + " ('" + Cmb_nen_str + "' || '/' || '" + Cmb_tsuki_str + "')"
                            //                                        + " end"
                            ...
                            //+ " where c4_y::text || '/' || c4_m::Text = case when length('" + Cmb_tsuki_str + "')=1 then"
                            //                                        + " ('" + Cmb_nen_str + "' || '/ ' || '" + Cmb_tsuki_str + "')"
                            //                                        + "       when length('" + Cmb_tsuki_str + "')=2 then"
                            //                                        + " ('" + Cmb_nen_str + "' || '/' || '" + Cmb_tsuki_str + "')"
                            //                                        + " end"
                            ...
                            + ")"
                            //+ " and c.c4_y::text || '/' || c.c4_m::Text = case when length('" + Cmb_tsuki_str + "')=1 then"
                            //                                        + " ('" + Cmb_nen_str + "' || '/ ' || '" + Cmb_tsuki_str + "')"
                            //                                        + "       when length('" + Cmb_tsuki_str + "')=2 then"
                            //                                        + " ('" + Cmb_nen_str + "' || '/' || '" + Cmb_tsuki_str + "')"
                            //                                        + " end"
