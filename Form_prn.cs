                                        ...
                                        + "("
                                            + "("
                                                + "(t_seikyu a LEFT JOIN t_syubetsu b"
                                                    + " ON a.s_id::Integer = b.s_id"
                                                    + " AND a.o_id::Integer = b.o_id"
                                                + ")"
                                            + " LEFT JOIN t_par c ON a.p_id::Integer = c.p_id"
                                            + ")"
                                        + " LEFT JOIN t_req d ON a.req_id::Integer = d.req_id"
                                        + ")"
                                    + " LEFT JOIN t_syutsuryokubi e ON a.s_id::Text = e.s_id"
                                    + ")"
                                ...
                                + " ("
                                    + "("
                                        + "("
                                            ...
                                            + " ON a.s_id::Integer = b.s_id AND a.o_id::Integer = b.o_id)"
                        ...
                        + "("
                            + "("
                                + "("
                                            ...
                                            + "("
                                                + "("
                                                    + "("
                                                        ...
                                                        + " LEFT JOIN (SELECT o_id, o_name, o_phone_number FROM t_office) f1 ON a.o_id = f1.o_id)"
                                    ...
                                    + " LEFT JOIN (SELECT m_id, manager, start_date, end_date, o_id FROM t_manager) m ON m.o_id::Text= '" + Form_Seikyu_TextBoxO_id + "'"
                ...
                case 5: // 引落請求書
                    {
                        ...
                        else
                        {
                            ...
                            + " WHERE NOT EXISTS ("
                                                ...
                                                + " WHERE"
                                                + " a.c4_y::Text = CASE WHEN length('" + Cmb_nen_str + "')=2 THEN"
                                                                        + " substr('" + Cmb_nen_str + "',1,1) || ' ' || substr('" + Cmb_nen_str + "', length('" + Cmb_nen_str + "')-1+1, length('" + Cmb_nen_str + "'))"
                                                                    + " ELSE"
                                                                        + "'" + Cmb_nen_str + "'"
                                                                    + " END"
                            ...
                            + " AND NOT EXISTS ("
                                            ...
                                            + " WHERE"
                                            + " d.c4_y::Text = CASE WHEN length('" + Cmb_nen_str + "')=2 THEN"
                                                                    + " substr('" + Cmb_nen_str + "',1,1) || ' ' || substr('" + Cmb_nen_str + "', length('" + Cmb_nen_str + "')-1+1, length('" + Cmb_nen_str + "'))"
                                                                + " ELSE"
                                                                    + "'" + Cmb_nen_str + "'"
                                                                + " END"
                ...
                case '0': // 
                    {
                        ...
                        + "WITH RECURSIVE r as ("
                            ...
                            + " ON h.c9 = b.b_code, t_office o, t_manager m, t_syubetsu x"
                            + " WHERE x.o_id = h.o_id"
                            + " AND x.s_id = h.s_id::Integer"
                            + " AND x.o_id::Text= '" + Form_Seikyu_TextBoxO_id + "'"
                            + " AND m.o_id::Text= '" + Form_Seikyu_TextBoxO_id + "'"
