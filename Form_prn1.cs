...
namespace rk_seikyu
{
    public partial class Form_prn1 : Form
    {
        ...
        private void Form_manager_Load(object sender, EventArgs e)
        {
            ...
            dataGridViewAbd.Columns[9].HeaderText = "種別ﾞ";
            ...
            // カラムを関連付け
            chk.DataPropertyName = "w_flg";
            c3.DataPropertyName = "c3";
            c19.DataPropertyName = "c19";
        ...
        private void Form_prn1_close_Click(object sender, EventArgs e)
        {
